...
fun TextIconHorizontalPreview() {
    SatoriTheme {
        Surface {
            TextIconHorizontal(text = "This is an example", icon = R.drawable.ic_star_filled_20)
        }
    }
}
...
fun TextIconVerticalPreview() {
    SatoriTheme {
        Surface {
            TextIconVertical(text = "This is an example", icon = R.drawable.ic_star_filled_20)
        }
    }
}